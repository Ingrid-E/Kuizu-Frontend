  ...
  return (
    <div className="exam-info">
      ...
      <div className="exam-info-content">
        ...
        <div className="exam-info-content-data">
          <div className="exam-info-content-dates">
            <DateInfoCard title="Inicio" text={formatDate(data.startAt)} />
            <DateInfoCard title="Finaliza" text={formatDate(data.endAt)} />
          </div>
          <div className="exam-info-content-values">
            <InfoActivitiesCard title="Numero de preguntas" count={questions} />
            <InfoActivitiesCard
              title="Numero de entregas"
              count={numCompleted.length}
            />
            <InfoActivitiesCard title="Faltan por entregar" count="5" />
          </div>
        </div>
      </div>
    </div>
